...
def get_agents_with_max_cases(subset_cases):
    """
...
def get_agents_with_min_cases(subset_cases):
    """
...
def calculate_average_handle_time(cases):
    """
...
def get_start_date(end_date, period, interval_count):
    """
...
def get_period(period_name, year):
    """
...
def get_agent_handled_cases_by_period(start_date, end_date):
    """
...
def get_qualified_agent_ids_by_case_count(agent_handled_cases, n_cases):
    """
...
def get_cases(start_date=None, end_date=None, agent_ids=None, case_ids=None, order_item_ids=None, issue_ids=None, statuses=None):
    """
...
def get_non_transferred_case_ids(start_date, end_date):
    """
    ...
    try:
        ...
        return [record['CaseId__c'] for record in results['records']]
...
def get_agent_transferred_cases_by_period(start_date, end_date, qualified_agent_ids=[]):
    """
...
def get_shipping_state(cases):
    ...
    try:
        ...
        account_states = {record['Id']: record['ShippingState'] for record in result['records']}
...
def calculate_region_average_closure_times(cases):
    """
...
def get_order_item_ids_by_product(product_id):
    """
...
def get_issue_counts(start_date, end_date, order_item_ids):
    """
    ...
    try:
        ...
        return {record["IssueId__c"]: record["IssueCount"] for record in result["records"]}
    
    except Exception as e:
        return f"Error: An unexpected error occurred - {str(e)}"


def find_id_with_max_value(values_by_id):
    """
...
def find_id_with_min_value(values_by_id):
    """
...
def get_account_id_by_contact_id(contact_id: str):
    """
...
def get_purchase_history(account_id, purchase_date, related_product_ids):
...
def get_month_to_case_count(cases):    
    """
...
def search_knowledge_articles(search_term):    
    """
...
def get_email_messages_by_case_id(case_id):
    """
...
def get_livechat_transcript_by_case_id(case_id):
    """
        ...
        "parameters": {
            ...
            "properties": {
                "subset_cases": {
                    ...
                    "description": "A list of case records, where each record is expected to have an 'OwnerId' field representing the agent ID.",
                },
            },
        ...
        "parameters": {
            ...
            "properties": {
                "cases": {
                    ...
                    "description": "A list of case dictionaries. Each case should have 'CreatedDate', 'ClosedDate', and 'OwnerId' keys.",
                },
            },
            "required": ["cases"],
        },
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "agent_ids": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "A list of agent IDs (User ID) to filter cases by.",
                },
                "case_ids": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "A list of case IDs to filter cases by.",
                },
                "order_item_ids": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "A list of order item IDs (OrderItem__c ID) to filter cases by.",
                },
                "issue_ids": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "A list of issue IDs (Issue__c ID) to filter cases by.",
                },
                "statuses": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "A list of case statuses to filter cases by.",
                },
            },
            "required": [],
        },
        ...
        "parameters": {
            ...
            "properties": {
                "cases": {
                    ...
                    "description": "A list of dictionaries, where each dictionary represents a case and contains at least 'AccountId' key.",
                },
            },
            "required": ["cases"],
        },
        ...
        "parameters": {
            ...
            "properties": {
                "cases": {
                    ...
                    "description": "A list of dictionaries, where each dictionary represents a case and contains at least 'ShippingState', 'CreatedDate', and 'ClosedDate' keys.",
                },
            },
            "required": ["cases"],
        },
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "order_item_ids": {
                    ...
                    "description": "A list of order item IDs to filter issues by.",
                },
            },
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "related_product_ids": {
                    ...
                    "description": "A list of product IDs to search for.",
                },
            },
        ...
        "parameters": {
            ...
            "properties": {
                "cases": {
                    ...
                    "description": "A list of dictionaries, where each dictionary represents a case and contains at least a 'CreatedDate' key with a value in the format 'YYYY-MM-DDTHH:MM:SSZ'.",
                },
            },
            "required": ["cases"],
        },
